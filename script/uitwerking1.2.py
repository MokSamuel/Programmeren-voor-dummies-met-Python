...
##Input vragen
golflengte = input("Welke golflengte heeft de straling? ")

if golflengte.isnumeric(): #BONUS: check of er een nummer is ingevoerd
    golflengte=float(golflengte) #maak van de input een nummer met getallen achter de komma
...
else: #BONUS: geen nummer ingevoerd
